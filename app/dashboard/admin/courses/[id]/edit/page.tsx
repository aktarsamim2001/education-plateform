                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input placeholder="Enter course title" {...field} onChange={handleTitleChange} />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <ImageUpload value={field.value} onChange={field.onChange} onUpload={handleImageUpload} />
                        </FormControl>
                        <FormDescription>Recommended size: 1280x720px (16:9)</FormDescription>
                        <FormMessage />
                      </FormItem>
                    )}
                  />
                                  ...
                                  <div key={lesson.id} className="rounded-md border p-4">
                                    ...
                                    <div className="grid grid-cols-1 gap-4">
                                      ...
                                      <div className="flex items-center space-x-2">
                                        <Switch
                                          ...
                                          onCheckedChange={(checked) =>
                                            updateLesson(moduleIndex, lessonIndex, "isPreview", checked)
                                          }
                                        />
                                        <label
                                      ...
                                      <div>
                                        ...
                                        <FileUpload
                                          value={lesson.attachment || ""}
                                          onChange={(url) => updateLesson(moduleIndex, lessonIndex, "attachment", url)}
